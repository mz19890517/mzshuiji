package com.mz.shunji.ui.editor
...
import com.mz.shunji.data.model.NoteTask
import com.mz.shunji.databinding.FragmentEditorBinding
import com.mz.shunji.databinding.LayoutAttachmentBinding
import com.mz.shunji.preferences.DefaultEditorMode
import com.mz.shunji.ui.attachments.dialog.EditAttachmentDialog
import com.mz.shunji.ui.attachments.fromUri
import com.mz.shunji.ui.attachments.recycler.AttachmentRecyclerListener
...
import com.mz.shunji.ui.editor.dialog.InsertImageDialog
import com.mz.shunji.ui.editor.dialog.InsertTableDialog
import com.mz.shunji.ui.editor.markdown.MarkdownSpan
...
import com.mz.shunji.ui.recorder.RecordAudioDialog
import com.mz.shunji.ui.reminders.EditReminderDialog
import com.mz.shunji.ui.tasks.TaskRecyclerListener
import com.mz.shunji.ui.tasks.TaskViewHolder
import com.mz.shunji.ui.tasks.TasksAdapter
import com.mz.shunji.ui.utils.ChooseFilesContract
import com.mz.shunji.ui.utils.TakePictureContract
import com.mz.shunji.ui.utils.collect
import com.mz.shunji.ui.utils.dp
import com.mz.shunji.ui.utils.getDimensionAttribute
import com.mz.shunji.ui.utils.getDrawableCompat
import com.mz.shunji.ui.utils.hideKeyboard
...
import com.mz.shunji.ui.utils.resId
...
import com.mz.shunji.ui.attachments.renderInlineContent
import com.mz.shunji.ui.widget.WidgetUpdateHelper
...
class EditorFragment : BaseFragment(R.layout.fragment_editor) {
    ...
    private val requestMediaLauncher = registerForActivityResult(ChooseFilesContract) { uris ->
        ...
        insertAttachmentsInline(attachments)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setFragmentResultListener(RECORD_CODE) { _, bundle ->
            ...
            insertAttachmentsInline(listOf(attachment))
        }
    ...
    private fun observeData() = with(binding) {
        model.data.collect(viewLifecycleOwner) { data ->
            ...
            // Update attachments
            val isInline = data.note.isInlineMode && !data.note.isList
